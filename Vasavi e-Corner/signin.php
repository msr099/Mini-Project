...
<html>
	...
	<body class="home-welcome-text" style="background-color:#ddd;">
		...
		<?php
			...
			>										</div>
													<div>
														<td>
															<input name="mobile" placeholder="Enter Your Mobile" required="required" class="email signupbox" type="text" size="30" pattern="[6789][0-9]{9}" title="Enter a 10 digit number starting with 6/7/8/9 only!" value="'.$u_mobile.'">
														</td>
													</div>
													<div>
														<td>
															<input name="signupaddress" placeholder="Primary location in college" required="required" class="email signupbox" type="text" size="30" value="'.$u_address.'">
														</td>
													</div>
													<div>
														<td>
															<input name="password" id="password-1" required="required"  placeholder="Enter New Password" class="password signupbox " type="password" size="30" pattern=".{8,}" title="Enter minimum 8 characters" value="'.$u_pass.'">
														</td>
													</div>
													<div>
														<input name="signup" class="uisignupbutton signupbutton" style="color:#1d3557;" type="submit" value="Sign Me Up!">
													</div>
