			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						$result = mysqli_query($link,"INSERT INTO admin (firstName,lastName,email,mobile,address,password,type) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]','$_POST[admintype]')");
										...
										<div>
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													...
													<div>
														<input name="signup" class="uisignupbutton signupbutton" style="background-color:#ed525d;" type="submit" value="Add Admin!">
													</div>
