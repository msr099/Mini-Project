...
if (!isset($_SESSION['admin_login'])) {
	...
	if (isset($_REQUEST['eoid'])) {
		...
		$eoid = $_REQUEST['eoid'];
		$getposts5 = mysqli_query($link,"SELECT * FROM orders WHERE id='$eoid'") or die(mysqli_error());
...
$getposts = mysqli_query($link,"SELECT * FROM products WHERE id ='$eopid'") or die(mysqli_error());
