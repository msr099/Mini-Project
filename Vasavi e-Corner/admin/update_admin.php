		...
		if (strlen($_POST['first_name']) >2 && strlen($_POST['first_name']) <16 ) {
			if ($check == 0 ) {
				if (strlen($_POST['password']) >4 ) {
					...
					if($utype_db == 'admin'){
						$result = mysqli_query($link,"UPDATE admin SET firstName='$_POST[first_name]', lastName='$_POST[last_name]', email='$u_email', mobile='$u_mobile', address='$u_address', password='$_POST[password]', type='$u_admin_type' WHERE id='$user'");
					}else{
						$result = mysqli_query($link,"UPDATE admin SET firstName='$_POST[first_name]', lastName='$_POST[last_name]', email='$u_email', mobile='$u_mobile', address='$u_address', password='$_POST[password]' WHERE id='$user'");
					}
		...
		<div class="homepageheader">
			<div class="signinButton loginButton">
				...
				<div class="uiloginbutton signinButton loginButton">
					<?php
						if ($user!="") {
							echo '<a style="text-decoration: none; color: #fff;" href="update_admin.php">Hi '.$uname_db.'</br></a>';
						}
						else {
											...
											<form action="" method="POST" class="registration">
												<div class="signup_form">
													...
													if($utype_db == 'admin'){
													 ...
													 echo ' <div>
														<input name="signup" class="uisignupbutton signupbutton" style="color:#1d3557" type="submit" value="Update Admin">
													</div>
