...
$getposts = mysqli_query($link,"SELECT * FROM products WHERE id ='$epid'") or die(mysqli_error());
...
if (isset($_POST['updatepro'])) {
	...
	if($result = mysqli_query($link,"UPDATE products SET pName='$_POST[pname]',price='$_POST[price]',description='$_POST[descri]',available='$_POST[available]',type='$_POST[type]',item='$_POST[item]',pCode='$_POST[code]' WHERE id='$epid'")){
...
if (isset($_POST['delprod'])) {
	$getposts1 = mysqli_query($link,"SELECT pid FROM orders WHERE pid='$epid'") or die(mysqli_error());
						...
						<div>
							<form action="" method="POST" class="registration">
								<div class="signup_form">
									...
									<div>
										<td >
											<input name="piece" style=" id="piece" required="required" class="piece signupbox" type="text" size="30" value="'.$piece.'" >
										</td>
									</div>
									<div>
										<td>
									...
									<div>
										<input name="updatepro" class="uisignupbutton signupbutton" style="color:#1d3557;" type="submit" value="Update Product">
									</div>
									<div>
										<input name="delprod" class="uisignupbutton signupbutton" style="color:#1d3557" type="submit" value="Delete This Product">
									</div>
							...
							<li>
								<form action="" method="POST" class="registration" enctype="multipart/form-data">
										<div class="signup_form">
											<div>
												<td>
													<input name="profilepic" style="width: 250px; margin-left:-20px;" class="password signupbox" type="file" value="Add Picture">
												</td>
											</div>
											<div>
												<input name="updatepic" style="width: 144px; margin-left:40px; color:#1d3557" class="uisignupbutton signupbutton" type="submit" value="Change Picture">
											</div>
											<div class="signup_error_msg">';
											if(isset($error_message)) {echo $error_message;}
											' </div>
